...
bool base_object::marked() const
{
    return utils::pun_read<std::uintptr_t>(utils::pun_read<char *>(this->real)) & 0b10;
}

void base_object::mark()
{
    utils::pun_write(this->real, utils::pun_reinterpret<char *>(utils::pun_reinterpret<std::uintptr_t>(utils::pun_read<char *>(this->real)) | 0b10));
}
